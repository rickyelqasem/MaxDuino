...
//#define WRITE_HIGH              digitalWrite(outputPin,HIGH)
  ...
  #define outputPin           9
  // RP2040 tape output runs from the ISR, so use direct SIO writes instead of
  // digitalWrite(), which reconfigures the pin function on every edge here.
...
//
  const byte chipSelect = 13;         // SD CS

  #define btnUp         0             // GP0
  #define btnDown       1             // GP1
  #define btnStop       2             // GP2
  #define btnPlay       3             // GP3
  #define btnMotor      6             // GP6 REM / motor sense
  #define btnRoot       7             // GP7

  #define RP2040_I2C_SDA_PIN 4        // GP4
  #define RP2040_I2C_SCL_PIN 5        // GP5
  #define RP2040_SD_SCK_PIN 10        // GP10
  #define RP2040_SD_MOSI_PIN 11       // GP11
  #define RP2040_SD_MISO_PIN 12       // GP12
